...
namespace happyml {
    ...
    class TensorWindowView : public happyml::BaseTensorUnaryOperatorView {
    public:
        TensorWindowView(const shared_ptr<BaseTensor> &tensor, size_t start_column, size_t end_column)
        ...
        void printMaterializationPlan() override {
            cout << "TensorWindowView{" << rowCount() << "," << columnCount() << "," << channelCount() << "}->";
