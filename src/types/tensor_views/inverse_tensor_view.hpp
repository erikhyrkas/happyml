...
namespace happyml {
    ...
    class InverseTensorView : public BaseTensorUnaryOperatorView {
    public:
        explicit InverseTensorView(const std::shared_ptr<BaseTensor> &tensor)
        ...
        void printMaterializationPlan() override {
            cout << "InverseTensorView{" << rowCount() << "," << columnCount() << "," << channelCount() << "}->";
