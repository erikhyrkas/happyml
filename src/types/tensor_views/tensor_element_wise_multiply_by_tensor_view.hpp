...
#ifndef HAPPYML_TENSOR_ELEMENT_WISE_MULTIPLY_BY_TENSOR_VIEW_HPP
#define HAPPYML_TENSOR_ELEMENT_WISE_MULTIPLY_BY_TENSOR_VIEW_HPP
...
namespace happyml {
    ...
    class TensorElementWiseMultiplyByTensorView : public happyml::BaseTensorBinaryOperatorView {
    public:
        TensorElementWiseMultiplyByTensorView(const shared_ptr<BaseTensor> &tensor1,
                                              const shared_ptr<BaseTensor> &tensor2)
                : BaseTensorBinaryOperatorView(tensor1, tensor2) {
...
#endif //HAPPYML_TENSOR_ELEMENT_WISE_MULTIPLY_BY_TENSOR_VIEW_HPP
