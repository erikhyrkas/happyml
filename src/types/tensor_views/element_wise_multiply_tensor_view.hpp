...
#ifndef HAPPYML_ELEMENT_WISE_MULTIPLY_TENSOR_VIEW_HPP
#define HAPPYML_ELEMENT_WISE_MULTIPLY_TENSOR_VIEW_HPP
...
namespace happyml {
    ...
    public:
        ...
        void printMaterializationPlan() override {
            cout << "ElementWiseMultiplyTensorView{" << rowCount() << "," << columnCount() << "," << channelCount()
                 << "}->(";
...
#endif //HAPPYML_ELEMENT_WISE_MULTIPLY_TENSOR_VIEW_HPP
