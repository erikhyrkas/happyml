...
#ifndef HAPPYML_MATRIX_MULTIPLY_TENSOR_VIEW_HPP
#define HAPPYML_MATRIX_MULTIPLY_TENSOR_VIEW_HPP
...
namespace happyml {
    ...
    public:
        ...
        void printMaterializationPlan() override {
            cout << "MatrixMultiplyTensorView{" << rowCount() << "," << columnCount() << "," << channelCount()
                 << "}->(";
...
#endif //HAPPYML_MATRIX_MULTIPLY_TENSOR_VIEW_HPP
