...
#ifndef HAPPYML_NORMALIZE_TENSOR_VIEW_HPP
#define HAPPYML_NORMALIZE_TENSOR_VIEW_HPP
...
namespace happyml {
    ...
    public:
        ...
        void printMaterializationPlan() override {
            cout << "NormalizeTensorView{" << rowCount() << "," << columnCount() << "," << channelCount()
                 << "}->";
...
#endif //HAPPYML_NORMALIZE_TENSOR_VIEW_HPP
