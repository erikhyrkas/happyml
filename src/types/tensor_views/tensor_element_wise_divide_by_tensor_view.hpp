...
#ifndef HAPPYML_TENSOR_ELEMENT_WISE_DIVIDE_BY_TENSOR_VIEW_HPP
#define HAPPYML_TENSOR_ELEMENT_WISE_DIVIDE_BY_TENSOR_VIEW_HPP
...
namespace happyml {
    ...
    class TensorElementWiseDivideByTensorView : public happyml::BaseTensorBinaryOperatorView {
    public:
        TensorElementWiseDivideByTensorView(const shared_ptr<BaseTensor> &tensor1,
        ...
        void printMaterializationPlan() override {
            cout << "TensorDivideTensorView{" << rowCount() << "," << columnCount() << "," << channelCount()
                 << "}->(";
...
#endif //HAPPYML_TENSOR_ELEMENT_WISE_DIVIDE_BY_TENSOR_VIEW_HPP
