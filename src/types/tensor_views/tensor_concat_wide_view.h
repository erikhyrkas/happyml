...
#ifndef HAPPYML_TENSOR_CONCAT_WIDE_VIEW_H
#define HAPPYML_TENSOR_CONCAT_WIDE_VIEW_H

#include "../base_tensors.hpp"

namespace happyml {
    class TensorConcatWideView : public happyml::BaseTensorBinaryOperatorView {
    public:
        TensorConcatWideView(const shared_ptr<BaseTensor> &tensor1,
        ...
        void printMaterializationPlan() override {
            cout << "TensorConcatWideView{" << rowCount() << "," << columnCount() << "," << channelCount() << "}->(";
...
#endif //HAPPYML_TENSOR_CONCAT_WIDE_VIEW_H
