...
#ifndef HAPPYML_SUM_TO_CHANNEL_TENSOR_VIEW_HPP
#define HAPPYML_SUM_TO_CHANNEL_TENSOR_VIEW_HPP
...
// but combine the resulting tensor with other tensors.
    class SumToChannelTensorView : public BaseTensorUnaryOperatorView {
    public:
        SumToChannelTensorView(const std::shared_ptr<BaseTensor> &tensor, size_t data_channel_index,
        ...
        void printMaterializationPlan() override {
            cout << "SumToChannelTensorView{" << rowCount() << "," << columnCount() << "," << channelCount() << "}->";
...
#endif //HAPPYML_SUM_TO_CHANNEL_TENSOR_VIEW_HPP
