...
namespace happyml {
    shared_ptr<Lexer> initializeHappymlLexer() {
        ...
        patterns.push_back(createKeywordToken("describe"));
        ...
        patterns.push_back(createKeywordToken("accuracy"));
        patterns.push_back(createKeywordToken("dataset"));
        patterns.push_back(createKeywordToken("datasets"));
        patterns.push_back(createKeywordToken("future"));
        patterns.push_back(createKeywordToken("image"));
        patterns.push_back(createKeywordToken("input"));
        patterns.push_back(createKeywordToken("label"));
        patterns.push_back(createKeywordToken("memory"));
        patterns.push_back(createKeywordToken("number"));
        patterns.push_back(createKeywordToken("speed"));
        patterns.push_back(createKeywordToken("task"));
        patterns.push_back(createKeywordToken("tasks"));
        patterns.push_back(createKeywordToken("text"));
        ...
        patterns.push_back(createKeywordToken("goal"));
        patterns.push_back(createKeywordToken("header"));
        patterns.push_back(createKeywordToken("limit"));
        patterns.push_back(createKeywordToken("pretty"));
        patterns.push_back(createKeywordToken("raw"));
        patterns.push_back(createKeywordToken("starting"));
        patterns.push_back(createKeywordToken("test"));
