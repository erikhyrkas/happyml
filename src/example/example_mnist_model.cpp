...
int main() {
    try {
        ...
        auto neuralNetwork = neuralNetworkBuilder()
                ->addInput(mnistDataSource->getGivenShape(), 32, NodeType::full, ActivationType::relu)
//                ->addNode(16, NodeType::full, ActivationType::relu)
                ->addOutput(mnistDataSource->getExpectedShape(), ActivationType::sigmoid)
                ->build();
        neuralNetwork->train(mnistDataSource, 5);
